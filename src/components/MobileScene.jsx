...
//   // { id: "OurOffice",x: -4, y: 0.8, z: 0, rotX: 0, rotY:  rotZ: -.6, scale: 0.9 },
//   // { id: "OurClients", x: 4, y: 0, z: 0, rotX: 0,8, rotY: 5, rotZ: -0.3, scale: 0.7 },
...
const MODEL_STATES = [
  ...
  { id: "page2", x: -.5, y: 0, z: 0, rotX: 0, rotY: 2, rotZ: 0.3, scale: 1 },
  { id: "page3", x: 0, y: 0, z: 0, rotX: 0, rotY: 2, rotZ: -0.9, scale: 1 },
  { id: "choose", x: .5, y: 0, z: 0, rotX: 0, rotY: -1, rotZ: 0.2, scale: 1.2 },
  { id: "work", x: 0, y: .5, z: 0, rotX: 0, rotY: -1, rotZ: -0.3, scale: 0.7 },
  { id: "port", x: -.5, y: -.5, z: 0, rotX: 0, rotY: -4, rotZ: -0.6, scale: 0.5 },
  { id: "test", x: -1, y: -.5, z: 0, rotX: .5, rotY: 0, rotZ: 0, scale: 0.5 },
